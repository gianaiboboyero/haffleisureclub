...
export function AiLoader({ className }: { className?: string }) {
  return (
    <div className={cn("relative flex min-h-screen items-center justify-center overflow-hidden bg-forest px-6 text-ivory", className)} role="status" aria-label="Loading">
